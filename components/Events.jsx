    ...
    <>
      ...
      >
        <Image
          ...
          className="opacity-20 absolute top-[13rem] right-[3rem] md:right-8 h-[30rem] w-[30rem] md:-translate-y-[10rem] -translate-y-[23rem] rotate-[-40deg] md:rotate-[-10deg] md:h-[30rem] md:w-[23rem]"
          alt=""
        />
